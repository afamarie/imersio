...
/* harmony import */ var _modules_sliders_sliders__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/sliders/sliders */ "./js/modules/sliders/sliders.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    burger.init();
    var header = new _modules_header_sticky_header__WEBPACK_IMPORTED_MODULE_3__["StickyHeader"]();
    header.init();
...
/*!******************************!*\
  !*** ./js/mocks/homepage.js ***!
  \******************************/
/*! exports provided: INTRO_DATA, GALLERY_DATA */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INTRO_DATA", function() { return INTRO_DATA; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GALLERY_DATA", function() { return GALLERY_DATA; });
var INTRO_DATA = [{
  id: 'concept',
  link: 'gallery.html#concept-art',
  title: 'concept art'
}, {
  id: 'cover',
  link: 'gallery.html#cover-art',
  title: 'cover art'
}, {
  id: 'assets',
  link: 'gallery.html#game-assets',
  title: 'game assets'
}];
var GALLERY_DATA = [{
  title: 'krastorio',
...
/*!***************************************!*\
  !*** ./js/modules/sliders/sliders.js ***!
  \***************************************/
/*! exports provided: swiperIntro, swiperGallery */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swiperIntro", function() { return swiperIntro; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swiperGallery", function() { return swiperGallery; });
...
/* harmony import */ var _mocks_homepage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../mocks/homepage */ "./js/mocks/homepage.js");
...
var swiperIntro = new _vendor_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0___default.a('.swiper--intro', {
  loop: true,
...
var swiper1 = document.querySelector('.swiper--intro');
var info = swiper1.querySelector('#intro-info');
var link = info.querySelector('a');
var title = info.querySelector('h2');
swiperIntro.on('slideChange', function () {
  title.classList.add('fade');
  setTimeout(function () {
    var activeSlide = swiper1.querySelector('.swiper-slide-active');
    link.href = _mocks_homepage__WEBPACK_IMPORTED_MODULE_1__["INTRO_DATA"][activeSlide.id].link;
    title.textContent = _mocks_homepage__WEBPACK_IMPORTED_MODULE_1__["INTRO_DATA"][activeSlide.id].title;
...
var swiperGallery = new _vendor_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0___default.a('.swiper--gallery', {
  loop: true,
  watchSlidesProgress: true,
  slidesPerView: 1,
  spaceBetween: 150,
...
var swiper2 = document.querySelector('.swiper--gallery');
var info2 = swiper2.querySelector('#gallery-info');
var title2 = info2.querySelector('h3');
var category2 = info2.querySelector('h4');
var description = info2.querySelector('p');
swiperGallery.on('slideChange', function () {
  setTimeout(function () {
    var activeSlide = swiper2.querySelector('.swiper-slide-active');
    info2.href = _mocks_homepage__WEBPACK_IMPORTED_MODULE_1__["GALLERY_DATA"][activeSlide.id].link;
    title2.textContent = _mocks_homepage__WEBPACK_IMPORTED_MODULE_1__["GALLERY_DATA"][activeSlide.id].title;
    category2.textContent = _mocks_homepage__WEBPACK_IMPORTED_MODULE_1__["GALLERY_DATA"][activeSlide.id].category;
    description.textContent = _mocks_homepage__WEBPACK_IMPORTED_MODULE_1__["GALLERY_DATA"][activeSlide.id].description;
  }, 300);
});
findSwipers();
